...
if(window.scrollY>500){
    ...
    return (
        ...
        <Nav style={navbar?{background:'green',padding:'15px 0'}:{background:''}}>
        <MaxWidthDiv class="max-width">
            <LogoDiv class="logo"><a href="#">Portfo<span style={navbar?{color:'#fff'}:{color:'green'}}>lio.</span></a></LogoDiv>
            <Menu class="menu">
    <Links
    activeClass="active"
    to="home"
